        ...
        <div class="page-wrapper">
                    ...
                    <div class="col-6">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 d-flex align-items-center">
                              ...
                              <li class="breadcrumb-item"><a href="<?= base_url('admin/pengelola') ?>" class="link">Pengelola</a></li>
                              <li id="admin-nama-breadcrumb" class="breadcrumb-item active" aria-current="page">{nama_pengelola}</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col-6">
            ...
            <div class="container-fluid">
                ...
                <!-- <div class="d-flex justify-content-between">
                    <div></div>
                    <div>
                        <button id="ubahInformasiBtn" class="btn btn-danger text-white mb-2 mb-md-0 me-2">Hapus</button>
                    </div>
                </div> -->
                <!-- <hr> -->
                <!-- Row -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="text-center mb-4">
                                    <img src="http://mahameru.test/assets/images/users/5.jpg" alt="user" width="100" class="rounded-circle">
